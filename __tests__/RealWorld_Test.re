...
// This is meant to provide a more realistic example of unit testing real modules
// with module types as interfaces and leveraging module functors for dependency injection.
